...
describe('LoginComponent', () => {
  it('effectue une connexion réussie avec des informations valides', async () => {
    ...
    fireEvent.change(screen.getByRole('textbox', { name: /password/i }), { target: { value: 'correctpassword' } });
  ...
  it('affiche une erreur si un champ obligatoire est manquant', async () => {
    ...
    fireEvent.change(screen.getByRole('textbox', { name: /password/i }), { target: { value: 'password123' } });
